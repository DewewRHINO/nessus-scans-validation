...
# Disable warnings for SSL Certificate for demonstration purposes only
...
# Add the token to the request headers for authentication, this is the token we got earlier.
headers = {
